...
// 切桥：清空选择并默认选第一断面（注意：实时数据可能稍后到，onMounted 也会兜底初始化）
watch(
  selectedBridgeId,
  async () => {
...
onMounted(async () => {
  ...
  // 兜底：首次进入如果 watch 未选中断面/传感器，则这里补选
  await nextTick()
  ...
  <div class="screen">
    ...
    <main class="grid">
      ...
      <section class="panel left">
        ...
        <div class="block">
          <div class="block-title">断面状态（{{ currentBridge?.name || '未选择' }}）</div>
        ...
        <div class="block">
          ...
          <div class="section-sensors">
            <div v-if="!currentSection" class="empty-tip">请先选择断面</div>
      ...
      <section class="panel mid">
        ...
        <div class="chart-container">
          <div v-if="!selectedSensorCode" class="empty-tip">请选择断面中的传感器</div>
